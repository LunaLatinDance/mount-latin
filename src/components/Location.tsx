  ...
  return (
    <section id="location" className="py-24 md:py-32 bg-dark relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start stagger">
          <div className="rounded-2xl overflow-hidden border border-white/5 shadow-xl h-[400px]">
            <iframe
              title={current.name}
          ...
          <div className="space-y-6">
            <div className="bg-dark/50 backdrop-blur border border-white/5 rounded-2xl p-8">
